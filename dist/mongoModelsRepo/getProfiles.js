            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    sinceFilter = (opts.since !== undefined
                        ...
                        : {});
                    filter = __assign({ agent: opts.agent, lrs: new mongodb_1.ObjectID(opts.client.lrs_id), organisation: new mongodb_1.ObjectID(opts.client.organisation) }, sinceFilter);
