...
describe('overwriteProfile replacing profiles', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, service.overwriteProfile({
                            agent: testValues_1.TEST_MBOX_AGENT,
                            client: testValues_1.TEST_CLIENT,
    ...
    it('should not overwrite existing models when using a non-existing model', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, overwriteProfile_1.default(testValues_1.TEST_MBOX_AGENT, testValues_1.TEST_CONTENT)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, assertProfile_1.default(testValues_1.TEST_CONTENT)];
                case 3:
...
//# sourceMappingURL=replacingProfile.test.js.map